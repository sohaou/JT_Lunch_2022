...
public class MenuPlannerServiceImpl implements MenuPlannerService{
	...
	/*
	 * @Override public int likecountrice(String steamed_rice) { return
	 * menuplannerDAO.likecountrice(steamed_rice); }
	 * 
	 * @Override public int likecountsoup(String soup) { return
	 * menuplannerDAO.likecountsoup(soup); }
	 * 
	 * @Override public int likecountsidedish(String side_dish) { return
	 * menuplannerDAO.likecountsidedish(side_dish); }
	 */
