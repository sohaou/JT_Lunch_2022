...
public class UserNoticeDTO {
		...
		public String toString() {
			return "UserNoticeDTO [notice_id=" + notice_id + ", title=" + title + ", content=" + content + ", writer="
					+ writer + ", up_date=" + up_date + ", user_check=" + user_check + ", editor=" + editor
					+ ", edit_time=" + edit_time + ", pop_up=" + pop_up + "]";
		}
}
