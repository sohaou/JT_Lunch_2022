...
public class OwnerBoardController {
	...
	private static final Logger log = LoggerFactory.getLogger(OwnerBoardController.class);
	...
	public String noticeModify(@RequestParam("id") int notice_id, Model model) throws Exception{
		model.addAttribute("noticeDetail", ownerNoticeService.OwnerNoticeDetail(notice_id));
