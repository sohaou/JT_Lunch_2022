...
public class MenuDAO {
	...
	//테이블에 저장된 모든 메뉴를 분류에 따라 출력
	public List<String> printMenuType(String menu_type) {
		// TODO Auto-generated method stub
		return sqlSession.selectList("menu.printMenuType",menu_type);
	}
	//테이블에 저장된 총 메뉴 수
	...
	/*
	 * //식당 운영자 _ 좋아요 수 상위 10개 메뉴 출력 public List<MenuDTO> selectLikeCount10() { //
	 * TODO Auto-generated method stub return
	 * sqlSession.selectList("menu.selectLikeCount10"); }
	 */
}
