...
public class MenuServiceImpl implements MenuService{
	...
	@Override
	public List<String> printMenuType(String menu_type) throws Exception{
		return dao.printMenuType(menu_type);
	}
	//수정할 메뉴 정보 가져오기
	@Override
	...
	/*
	 * @Override public List<MenuDTO> selectLikeCount10() throws Exception{ return
	 * dao.selectLikeCount10(); }
	 */
}
