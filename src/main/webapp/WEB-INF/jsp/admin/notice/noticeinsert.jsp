...
<style>
	...
	<main>
		...
		<form action= '<c:url value="/admin/noticeInsert"/>' method="POST">
			<table id="SearchResult" style="width:90%; margin-left:40px; font-size:16px;">
				<thead>
					<tr>
						<th class="table-center" style="width:20%; padding:10px;">제목</th>
						<td><input type="text" id="title" name="title" style="border: none; margin-left:20px; width: 80%; height: 30px;"></td>
					</tr>	
				</thead>
				<tbody id="Result">
					<tr>
						<th class="table-center" style="width:20%; padding:10px;">내용</th>
						<td><textarea id="content" name="content" style="border:none; margin-left:20px; width: 90%; height: 300px;"></textarea></td>
					</tr>
					<tr>
						<th style="width:27%; padding:5px;"> 팝업 설정 : </th>
						<td><input type="checkbox" name="pop_up" value="1">예</td>
					</tr>	
				</tbody>
			</table><br>
